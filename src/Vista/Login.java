...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login.setBackground(new java.awt.Color(53, 66, 89));
        login.setMaximumSize(new java.awt.Dimension(310, 80));
        login.setMinimumSize(new java.awt.Dimension(310, 80));
        login.setPreferredSize(new java.awt.Dimension(310, 80));
        ...
        usuario.setFont(new java.awt.Font("SF UI Display", 0, 14)); // NOI18N
        ...
        contraseña.setFont(new java.awt.Font("SF UI Display", 0, 14)); // NOI18N
        contraseña.setText("Contraseña:");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));
        jPanel3.setMaximumSize(new java.awt.Dimension(170, 42));
        jPanel3.setMinimumSize(new java.awt.Dimension(170, 42));
        jPanel3.setPreferredSize(new java.awt.Dimension(170, 42));

        txtContraseña.setFont(new java.awt.Font("SF UI Display", 0, 14)); // NOI18N
        txtContraseña.setBorder(null);
        txtContraseña.setMaximumSize(new java.awt.Dimension(120, 18));
        txtContraseña.setMinimumSize(new java.awt.Dimension(120, 18));
        txtContraseña.setPreferredSize(new java.awt.Dimension(120, 18));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/FondoLogin.png"))); // NOI18N
